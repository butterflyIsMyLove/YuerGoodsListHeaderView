...
- (void)setImagePositionWithType:(SSImagePositionType)type spacing:(CGFloat)spacing {
    ...
    switch (type) {
        ...
        case SSImagePositionTypeRight: {
            CGFloat titleEdgeInsetLeft = - imageSize.width;
            CGFloat titleEdgeInsetRight = imageSize.width + spacing;
            CGFloat imageEdgeInsetLeft = titleSize.width + spacing;
            CGFloat imageEdgeInsetRight = - titleSize.width;
            if (titleSize.width + imageSize.width + spacing > buttonSize.width) {
                imageEdgeInsetLeft = CGRectGetMaxX(self.titleLabel.frame);
            }
            self.titleEdgeInsets = UIEdgeInsetsMake(0, titleEdgeInsetLeft, 0, titleEdgeInsetRight);
            self.imageEdgeInsets = UIEdgeInsetsMake(0, imageEdgeInsetLeft, 0, imageEdgeInsetRight);
            break;
        }
